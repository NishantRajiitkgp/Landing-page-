        ...
        <div className="wrap hair-top" style={{ paddingTop: '120px', paddingBottom: '140px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 7fr) minmax(0, 5fr)', gap: '72px', alignItems: 'center' }}>
            ...
            <div>
              ...
              {' '}
              <div style={{ marginTop: '36px', display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '16px', maxWidth: '600px' }}>
                {' '}
                <div className="plan">
                  {' '}
                  <div className="ph1">
                  ...
                  {' '}
                  <a href="#" className="btn btn-line" style={{ width: '100%', marginTop: '16px' }}>
                    Buy Basic
                  </a>
                  {' '}
                </div>
        ...
        <div className="wrap sec hair-top">
          ...
          <div style={{ marginTop: '24px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div className="plan">
              ...
              {' '}
              <a href="#" className="btn btn-line full" style={{ marginTop: '14px' }}>
                Buy Basic
              </a>
              {' '}
            </div>
