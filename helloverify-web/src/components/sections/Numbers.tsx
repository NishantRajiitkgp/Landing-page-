/** Built on trust. Proven by numbers.
    ...
    One tree at every width since the phone pass (Sep 2026): the board has
    no 390px artboard, so `numbers.css` restacks it below 1081px rather than
    keeping the old generated `.mob` copy of the band. */
