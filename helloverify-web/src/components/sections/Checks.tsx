    ...
    <>
      <div className="dsk">
        <div className="wrap hair-top" style={{ paddingTop: '120px', paddingBottom: '140px' }}>
          ...
          <div style={{ marginTop: '72px' }}>
            ...
            {' '}
            <div className="lane" style={{ marginTop: '56px' }}>
              {' '}
              <div className="g">
                <div className="k">
                  02 — Work{' '}
      ...
      <div className="mob">
        <div className="wrap sec hair-top">
          {' '}
          <h2 className="h2">
            33 checks. Most take minutes.
          </h2>
          {' '}
          <p className="lede">
            Grouped by how long you wait, from upload to report.
          </p>
          {' '}
          <div style={{ marginTop: '32px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
            ...
            <div className="bucket">
              <div className="bk">
                ...
                <span className="k">
                  Identity, documents, records
                </span>
              </div>
              <div className="cloud">
                <span className="pl fast">
                  <span className="d">
                  </span>
                  Identity
                </span>
            ...
            <div className="bucket">
              <div className="bk">
                ...
                <span className="k">
                  Confirmed with a registrar, employer or authority
                </span>
              </div>
              <div className="cloud">
                <span className="pl">
