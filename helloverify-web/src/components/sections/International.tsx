    ...
    <>
      <div className="dsk">
        <div className="wrap hair-top" style={{ paddingTop: '120px', paddingBottom: '140px' }}>
          ...
          {' '}
          <div style={{ marginTop: '64px', display: 'grid', gridTemplateColumns: 'repeat(5, minmax(0, 1fr))', gap: '20px' }}>
            {' '}
            <div className="cc">
              {' '}
      ...
      <div className="mob">
        <div className="wrap sec hair-top">
          ...
          {' '}
          <div style={{ marginTop: '28px', display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: '14px' }}>
            {' '}
            <div className="cc">
              {' '}
              <div className="ccard ph" style={{ background: tint("/img/16-united-kingdom.jpg") }}>
