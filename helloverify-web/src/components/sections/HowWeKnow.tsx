/** How we know — one upload, then the work (homepage v2, Sep 2026; canvas
    ...
    One tree at every width; on a phone the case file stacks — specimen,
    then the chain of custody — and the steps go two by two
    (`app/v2/how.css`). Server-rendered frame; the route state and the run
    are the `./HowWeKnowStage` island, which gets the steps grid and the
    evidence heading as slots so they stay static. */
