  ...
  return (
    ...
    >
      <div className="wrap hero3">
        ...
        <div className="hrow">
          <a href="/contact" className="btn btn-ink">Ask about {c.name}</a>
          <a href="/platform/coverage" className="btn btn-ghost">
      ...
      {siblings.length > 0 && (
        <div className="wrap sec3" style={{ paddingBottom: 20 }}>
          ...
          <div className="body3 idx3">
            {siblings.map((s) => (
              <a className="x3" href={`/countries/${s.slug}`} key={s.slug}>
                <span className="xn">
                  {s.name}
          ...
          <div style={{ marginTop: 32 }}>
            <a href="/resources/countries" className="btn btn-line btn-sm">All country guides</a>
          </div>
        </div>
      )}
    </PageShell>
