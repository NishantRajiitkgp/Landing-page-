  ...
  return (
    ...
    >
      <div className="wrap hero3">
        ...
        <div className="hrow">
          <a href="/platform/security-compliance" className="btn btn-ink">Security &amp; compliance</a>
      ...
      <div className="wrap sec3">
        ...
        <div className="body3 paths3">
          <a href="/platform/technology" className="cell ph span3">
          ...
          <a href="/platform/security-compliance" className="cell ph span3">
          ...
          <a href="/platform/coverage" className="cell ph span3">
