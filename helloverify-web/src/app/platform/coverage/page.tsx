  ...
  return (
    ...
    >
      <div className="wrap hero3">
        ...
        <div className="hrow">
          <a href="/contact" className="btn btn-ink">Ask about a country</a>
      ...
      <div className="wrap sec3" id="countries">
        ...
        <div className="pricenote">
          ...
          the partner network — <a href="/contact" style={{ color: "inherit", textDecoration: "underline" }}>ask about a specific country</a>
        </div>
      </div>
