...
export default function GovernmentsHub() {
  return (
    <PageShell
    ...
    >
      ...
      <div className="wrap hero3">
        ...
        <div className="hrow">
          ...
          <a href="/platform/security-compliance" className="btn btn-ghost">
      ...
      <div className="wrap sec3">
        ...
        <div className="body3 paths3">
          {VERTICALS.map((c) => (
            <a key={c.href} href={c.href} className={`cell ph ${c.span}`}>
          ...
          <div className="cert">
            ...
            <div>
              ...
              <p className="p">
                ...
                <a href="/governments/manpower-education/ministry-of-manpower" style={{ fontWeight: 500 }}>read the story →</a>
              </p>
            </div>
          </div>
        </div>
