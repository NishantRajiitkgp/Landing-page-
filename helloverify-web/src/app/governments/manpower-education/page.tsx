...
export default function Page() {
  return (
    <VerticalPage
      ...
      tableNote={<>Times shown are from submission to result · credentials verified in the country of issue — see <a href="/platform/coverage" style={{ color: "inherit", textDecoration: "underline" }}>global coverage</a></>}
