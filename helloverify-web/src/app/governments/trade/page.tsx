...
export default function Page() {
  return (
    <VerticalPage
      ...
      tableNote={<>Times shown are from filing to result · company records verified in the country of registration — see <a href="/platform/coverage" style={{ color: "inherit", textDecoration: "underline" }}>global coverage</a></>}
