    ...
    <PageShell crumbs={[{ label: "Business" }]}>
      ...
      <div className="wrap hero3">
        ...
        <div className="hrow">
          ...
          <a href="/business/smb" className="btn btn-ghost">
      ...
      <div className="wrap sec3">
        ...
        <div className="body3 intg3">
          ...
          <a href="/platform/technology" className="btn btn-ghost btn-sm">
          ...
          <div className="cert">
            ...
            <div>
              ...
              <p className="p">
                ...
                <a href="/platform/security-compliance" style={{ fontWeight: 500 }}>Security &amp; compliance →</a>
              </p>
            </div>
          </div>
        </div>
